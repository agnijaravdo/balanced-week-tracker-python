...
def display_total_logged_in_hours_for_each_category():
    ...
    for activity in activities:
        ...
        if activity_date >= start_of_week and activity_date <= end_of_week and not activity.is_weekly:
            daily_goals_row = [
    ...
    weekly_headers = ["Category Name", "Is Weekly", "Weekly Target Hours", "Logged In Hours"]
    daily_goals_headers = ["Category Name", "Is Weekly", "Date", "Daily Target Hours", "Logged In Hours"]
